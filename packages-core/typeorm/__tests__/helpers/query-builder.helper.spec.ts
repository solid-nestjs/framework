...
describe('QueryBuilderHelper', () => {
  ...
  describe('getQueryBuilder', () => {
    ...
    it('should create query builder with find arguments', () => {
    ...
    it('should create query builder with data retrieval options', () => {
      const options: DataRetrievalOptions<TestEntity> = {
        mainAlias: 'customAlias',
        relations: [
          { property: 'customAlias.profile', alias: 'customAlias_profile' },
        ],
  ...
  describe('getNonMultiplyingPaginatedQueryBuilder', () => {
    it('should return false when no pagination is provided', () => {
      ...
      const result = helper.getNonMultiplyingPaginatedQueryBuilder(
        repository,
        args,
      );
  ...
  describe('protected methods', () => {
    describe('getRelationsArray', () => {
      it('should convert relations object to array format', () => {
        ...
        const result = (helper as any).getRelationsArray(
          'testentityclass',
          relations,
        );
        ...
        expect(result).toEqual([
          {
            ...
            alias: 'testentityclass_profile',
          },
          { property: 'testentityclass.tags', alias: 'testentityclass_tags' },
          {
            property: 'testentityclass_tags.posts',
            alias: 'testentityclass_tags_posts',
          },
        ]);
      });
      ...
      it('should handle nested relations', () => {
        ...
        expect(result).toEqual([
          ...
          {
            property: 'testentityclass_profile.user',
            alias: 'testentityclass_profile_user',
          },
          {
            property: 'testentityclass_profile_user.posts',
            alias: 'testentityclass_profile_user_posts',
          },
        ]);
      });
    ...
    describe('addRelation', () => {
      ...
      it('should add new relation and perform leftJoinAndSelect', () => {
        const result = (helper as any).addRelation(
          queryContext,
          'profile',
          'profile_alias',
          true,
    ...
    describe('getRelationPath', () => {
      ...
      it('should throw error for invalid property format', () => {
        const relation = {
          property: 'invalid.property.format',
          alias: 'alias',
        };
        ...
        expect(result).toThrow(
          'bad relation property format: invalid.property.format',
        );
      });
    });
    ...
    describe('getWhereCondition', () => {
      ...
      beforeEach(() => {
        whereContext = {
          ...
          alias: 'testentityclass',
          recusirveDepth: 0,
          constructField: (fieldName: string, value: any) => ({
            [fieldName]: value,
          }),
        };
      });
      ...
      it('should throw error when max recursive depth is exceeded', () => {
        ...
        const result = () =>
          (helper as any).getWhereCondition(whereContext, where);
    ...
    describe('getFieldConditions', () => {
      ...
      it('should handle string values', () => {
        const result = (helper as any).getFieldConditions(
          whereContext,
          'name',
          'John',
        );
      ...
      it('should throw error for invalid object condition', () => {
        const result = () =>
          (helper as any).getFieldConditions(whereContext, 'name', {});
      ...
      it('should throw error for non-object when expected', () => {
        const result = () =>
          (helper as any).getFieldConditions(
            whereContext,
            'name',
            Symbol('test'),
          );
    ...
    describe('getComplexConditions', () => {
      ...
      it('should handle single condition', () => {
        ...
        const result = (helper as any).getComplexConditions(
          whereContext,
          condition,
        );
    ...
    describe('hasFieldConditions', () => {
      ...
      it('should return true for Date values', () => {
        const result = (helper as any).hasFieldConditions(
          'createdAt',
          new Date(),
        );
      ...
      it('should return true for array values', () => {
        const result = (helper as any).hasFieldConditions('names', [
          'John',
          'Jane',
        ]);
      ...
      it('should return false for objects without condition keys', () => {
        const result = (helper as any).hasFieldConditions('profile', {
          bio: 'test',
        });
      ...
      it('should throw error for undefined values', () => {
        const result = () =>
          (helper as any).hasFieldConditions('name', undefined);
    ...
    describe('addRelationForConditionOrSorting', () => {
      ...
      it('should add relation and return alias for non-multiplying relations', () => {
        const addRelationSpy = jest
          .spyOn(helper as any, 'addRelation')
          .mockReturnValue({
            alias: 'profile_alias',
      ...
      it('should throw error when relation has no aggregatedCardinality', () => {
        ...
        const result = () =>
          (helper as any).addRelationForConditionOrSorting(context, 'profile');

        expect(result).toThrow(InternalServerErrorException);
        expect(result).toThrow(
          'no aggregatedCardinality for testentityclass.profile',
        );
      });
      ...
      it('should throw error for multiplying cardinality relations', () => {
        ...
        const result = () =>
          (helper as any).addRelationForConditionOrSorting(context, 'tags');

        expect(result).toThrow(InternalServerErrorException);
        expect(result).toThrow(
          'invalid aggregatedCardinality (many-to-many) for condition in property (testentityclass.tags), it will cause a multiplying join',
        );
      });
    });
    ...
    describe('relationCondition', () => {
      ...
      it('should create relation condition with updated context', () => {
        ...
        const result = (helper as any).relationCondition(
          whereContext,
          'profile',
          condition,
        );
