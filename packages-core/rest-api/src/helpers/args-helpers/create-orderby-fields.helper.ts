...
/**
 * Creates an OrderByFields class for sorting entities with REST API decorators.
 ...
 * @returns A dynamically generated OrderBy class with REST decorators
 * 
 * @example
 * ```typescript
 * import { createOrderByFields } from '@solid-nestjs/rest-api';
 * 
